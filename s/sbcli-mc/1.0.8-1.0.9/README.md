# Comparing `tmp/sbcli_mc-1.0.8.zip` & `tmp/sbcli_mc-1.0.9.zip`
...
## Comparing `sbcli_mc-1.0.8/README.md` & `sbcli_mc-1.0.9/README.md`
...
## Comparing `sbcli_mc-1.0.8/simplyblock_web/auth_middleware.py` & `sbcli_mc-1.0.9/simplyblock_web/auth_middleware.py`
...
## Comparing `sbcli_mc-1.0.8/simplyblock_web/blueprints/web_api_caching_node.py` & `sbcli_mc-1.0.9/simplyblock_web/blueprints/web_api_caching_node.py`
...
## Comparing `sbcli_mc-1.0.8/simplyblock_core/services/lvol_monitor.py` & `sbcli_mc-1.0.9/simplyblock_core/services/lvol_monitor.py`
...
## Comparing `sbcli_mc-1.0.8/simplyblock_core/models/compute_node.py` & `sbcli_mc-1.0.9/simplyblock_core/models/compute_node.py`

 * *Files identical despite different names*

## Comparing `sbcli_mc-1.0.8/simplyblock_core/models/events.py` & `sbcli_mc-1.0.9/simplyblock_core/models/events.py`

 * *Files identical despite different names*

## Comparing `sbcli_mc-1.0.8/simplyblock_core/models/global_settings.py` & `sbcli_mc-1.0.9/simplyblock_core/models/global_settings.py`

 * *Files identical despite different names*

## Comparing `sbcli_mc-1.0.8/simplyblock_core/models/job_schedule.py` & `sbcli_mc-1.0.9/simplyblock_core/models/job_schedule.py`

 * *Files identical despite different names*

## Comparing `sbcli_mc-1.0.8/simplyblock_core/models/base_model.py` & `sbcli_mc-1.0.9/simplyblock_core/models/base_model.py`

 * *Files identical despite different names*

## Comparing `sbcli_mc-1.0.8/simplyblock_core/models/lvol_model.py` & `sbcli_mc-1.0.9/simplyblock_core/models/lvol_model.py`

 * *Files identical despite different names*

## Comparing `sbcli_mc-1.0.8/simplyblock_core/models/snapshot.py` & `sbcli_mc-1.0.9/simplyblock_core/models/snapshot.py`

 * *Files identical despite different names*

## Comparing `sbcli_mc-1.0.8/simplyblock_core/models/storage_node.py` & `sbcli_mc-1.0.9/simplyblock_core/models/storage_node.py`

 * *Files identical despite different names*

## Comparing `sbcli_mc-1.0.8/simplyblock_core/models/stats.py` & `sbcli_mc-1.0.9/simplyblock_core/models/stats.py`

 * *Files identical despite different names*

## Comparing `sbcli_mc-1.0.8/simplyblock_core/models/pool.py` & `sbcli_mc-1.0.9/simplyblock_core/models/pool.py`

 * *Files identical despite different names*

## Comparing `sbcli_mc-1.0.8/simplyblock_core/models/iface.py` & `sbcli_mc-1.0.9/simplyblock_core/models/iface.py`

 * *Files identical despite different names*

## Comparing `sbcli_mc-1.0.8/simplyblock_core/models/cluster.py` & `sbcli_mc-1.0.9/simplyblock_core/models/cluster.py`

 * *Files identical despite different names*

## Comparing `sbcli_mc-1.0.8/simplyblock_core/models/port_stat.py` & `sbcli_mc-1.0.9/simplyblock_core/models/port_stat.py`

 * *Files identical despite different names*

## Comparing `sbcli_mc-1.0.8/simplyblock_core/scripts/install_deps.sh` & `sbcli_mc-1.0.9/simplyblock_core/scripts/install_deps.sh`

 * *Files identical despite different names*

## Comparing `sbcli_mc-1.0.8/simplyblock_core/scripts/__init__.py` & `sbcli_mc-1.0.9/simplyblock_core/scripts/__init__.py`

 * *Files identical despite different names*

## Comparing `sbcli_mc-1.0.8/simplyblock_core/scripts/haproxy.cfg` & `sbcli_mc-1.0.9/simplyblock_core/scripts/haproxy.cfg`

 * *Files identical despite different names*

## Comparing `sbcli_mc-1.0.8/simplyblock_core/scripts/stack_deploy_wait.sh` & `sbcli_mc-1.0.9/simplyblock_core/scripts/stack_deploy_wait.sh`

 * *Files identical despite different names*

## Comparing `sbcli_mc-1.0.8/simplyblock_core/scripts/docker-compose-swarm.yml` & `sbcli_mc-1.0.9/simplyblock_core/scripts/docker-compose-swarm.yml`

 * *Files identical despite different names*

## Comparing `sbcli_mc-1.0.8/simplyblock_core/scripts/docker-compose-swarm-monitoring.yml` & `sbcli_mc-1.0.9/simplyblock_core/scripts/docker-compose-swarm-monitoring.yml`

 * *Files identical despite different names*

## Comparing `sbcli_mc-1.0.8/simplyblock_core/scripts/deploy_stack.sh` & `sbcli_mc-1.0.9/simplyblock_core/scripts/deploy_stack.sh`

 * *Files identical despite different names*

## Comparing `sbcli_mc-1.0.8/simplyblock_core/scripts/alerting/alert_rules.yaml` & `sbcli_mc-1.0.9/simplyblock_core/scripts/alerting/alert_rules.yaml`

 * *Files identical despite different names*

## Comparing `sbcli_mc-1.0.8/simplyblock_core/scripts/alerting/alert_resources.yaml` & `sbcli_mc-1.0.9/simplyblock_core/scripts/alerting/alert_resources.yaml`

 * *Files identical despite different names*

## Comparing `sbcli_mc-1.0.8/simplyblock_core/scripts/dashboards/nodes.json` & `sbcli_mc-1.0.9/simplyblock_core/scripts/dashboards/nodes.json`

 * *Files identical despite different names*

## Comparing `sbcli_mc-1.0.8/simplyblock_core/scripts/dashboards/cluster.json` & `sbcli_mc-1.0.9/simplyblock_core/scripts/dashboards/cluster.json`

 * *Files identical despite different names*

## Comparing `sbcli_mc-1.0.8/simplyblock_core/scripts/dashboards/lvols.json` & `sbcli_mc-1.0.9/simplyblock_core/scripts/dashboards/lvols.json`

 * *Files identical despite different names*

## Comparing `sbcli_mc-1.0.8/simplyblock_core/scripts/dashboards/devices.json` & `sbcli_mc-1.0.9/simplyblock_core/scripts/dashboards/devices.json`

 * *Files identical despite different names*

## Comparing `sbcli_mc-1.0.8/simplyblock_core/scripts/dashboards/pools.json` & `sbcli_mc-1.0.9/simplyblock_core/scripts/dashboards/pools.json`

 * *Files identical despite different names*

## Comparing `sbcli_mc-1.0.8/simplyblock_core/scripts/dashboards/node-exporter.json` & `sbcli_mc-1.0.9/simplyblock_core/scripts/dashboards/node-exporter.json`

 * *Files identical despite different names*

## Comparing `sbcli_mc-1.0.8/sbcli_mc.egg-info/SOURCES.txt` & `sbcli_mc-1.0.9/sbcli_mc.egg-info/SOURCES.txt`

 * *Files identical despite different names*

## Comparing `sbcli_mc-1.0.8/sbcli_mc.egg-info/PKG-INFO` & `sbcli_mc-1.0.9/sbcli_mc.egg-info/PKG-INFO`
