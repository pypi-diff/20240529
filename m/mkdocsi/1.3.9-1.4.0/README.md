# Comparing `tmp/mkdocsi-1.3.9.tar.gz` & `tmp/mkdocsi-1.4.0.tar.gz`
...
## Comparing `mkdocsi-1.3.9.tar` & `mkdocsi-1.4.0.tar`
...
### Comparing `mkdocsi-1.3.9/PKG-INFO` & `mkdocsi-1.4.0/PKG-INFO`
...
### Comparing `mkdocsi-1.3.9/README.md` & `mkdocsi-1.4.0/README.md`

 * *Files identical despite different names*

### Comparing `mkdocsi-1.3.9/mkdocsi/__init__.py` & `mkdocsi-1.4.0/mkdocsi/__init__.py`
...
### Comparing `mkdocsi-1.3.9/mkdocsi.egg-info/PKG-INFO` & `mkdocsi-1.4.0/mkdocsi.egg-info/PKG-INFO`
...
### Comparing `mkdocsi-1.3.9/setup.py` & `mkdocsi-1.4.0/setup.py`
