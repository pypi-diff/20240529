# Comparing `tmp/mkdocsi-1.1.1.tar.gz` & `tmp/mkdocsi-1.1.2.tar.gz`
...
## Comparing `mkdocsi-1.1.1.tar` & `mkdocsi-1.1.2.tar`
...
### Comparing `mkdocsi-1.1.1/PKG-INFO` & `mkdocsi-1.1.2/PKG-INFO`
...
### Comparing `mkdocsi-1.1.1/mkdocsi/__init__.py` & `mkdocsi-1.1.2/mkdocsi/__init__.py`
...
### Comparing `mkdocsi-1.1.1/mkdocsi.egg-info/PKG-INFO` & `mkdocsi-1.1.2/mkdocsi.egg-info/PKG-INFO`
...
### Comparing `mkdocsi-1.1.1/setup.py` & `mkdocsi-1.1.2/setup.py`
