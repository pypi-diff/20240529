# Comparing `tmp/mkdocsi-1.3.2.tar.gz` & `tmp/mkdocsi-1.3.3.tar.gz`
...
## Comparing `mkdocsi-1.3.2.tar` & `mkdocsi-1.3.3.tar`
...
### Comparing `mkdocsi-1.3.2/PKG-INFO` & `mkdocsi-1.3.3/PKG-INFO`
...
### Comparing `mkdocsi-1.3.2/mkdocsi/Main.py` & `mkdocsi-1.3.3/mkdocsi/Main.py`

 * *Files identical despite different names*

### Comparing `mkdocsi-1.3.2/mkdocsi/__init__.py` & `mkdocsi-1.3.3/mkdocsi/__init__.py`

 * *Files identical despite different names*

### Comparing `mkdocsi-1.3.2/mkdocsi.egg-info/PKG-INFO` & `mkdocsi-1.3.3/mkdocsi.egg-info/PKG-INFO`
...
### Comparing `mkdocsi-1.3.2/setup.py` & `mkdocsi-1.3.3/setup.py`
