# Comparing `tmp/airbyte_source_mailjet_sms-0.1.3.tar.gz` & `tmp/airbyte_source_mailjet_sms-0.1.4.tar.gz`
...
### Comparing `airbyte_source_mailjet_sms-0.1.3/README.md` & `airbyte_source_mailjet_sms-0.1.4/README.md`
