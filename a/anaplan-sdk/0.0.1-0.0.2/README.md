# Comparing `tmp/anaplan_sdk-0.0.1.tar.gz` & `tmp/anaplan_sdk-0.0.2.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "anaplan_sdk-0.0.1.tar", max compression
+gzip compressed data, was "anaplan_sdk-0.0.2.tar", max compression
```

## Comparing `anaplan_sdk-0.0.1.tar` & `anaplan_sdk-0.0.2.tar`

### file list

```diff
@@ -1,9 +1,9 @@
--rw-r--r--   0        0        0      391 2024-05-27 09:58:55.018964 anaplan_sdk-0.0.1/anaplan_sdk/__init__.py
--rw-r--r--   0        0        0      145 2024-05-28 05:37:16.432090 anaplan_sdk-0.0.1/anaplan_sdk/_async_client.py
--rw-r--r--   0        0        0    22137 2024-05-29 08:28:17.515277 anaplan_sdk-0.0.1/anaplan_sdk/_client.py
--rw-r--r--   0        0        0     1664 2024-05-29 08:28:17.515277 anaplan_sdk-0.0.1/anaplan_sdk/_exceptions.py
--rw-r--r--   0        0        0     1632 2024-05-29 08:28:17.515277 anaplan_sdk-0.0.1/anaplan_sdk/_models.py
--rw-r--r--   0        0        0    11558 2024-05-27 16:31:14.513449 anaplan_sdk-0.0.1/LICENSE
--rw-r--r--   0        0        0     1245 2024-05-29 08:33:41.615437 anaplan_sdk-0.0.1/pyproject.toml
--rw-r--r--   0        0        0      766 2024-05-28 08:50:33.331362 anaplan_sdk-0.0.1/README.md
--rw-r--r--   0        0        0     1272 1970-01-01 00:00:00.000000 anaplan_sdk-0.0.1/PKG-INFO
...
### Comparing `anaplan_sdk-0.0.1/anaplan_sdk/_client.py` & `anaplan_sdk-0.0.2/anaplan_sdk/_client.py`
...
### Comparing `anaplan_sdk-0.0.1/LICENSE` & `anaplan_sdk-0.0.2/LICENSE`
...
### Comparing `anaplan_sdk-0.0.1/README.md` & `anaplan_sdk-0.0.2/README.md`
...
### Comparing `anaplan_sdk-0.0.1/PKG-INFO` & `anaplan_sdk-0.0.2/PKG-INFO`
