# Comparing `tmp/tenorgrabber-1.0.0.tar.gz` & `tmp/tenorgrabber-1.0.1.tar.gz`
...
## Comparing `tenorgrabber-1.0.0.tar` & `tenorgrabber-1.0.1.tar`
...
### Comparing `tenorgrabber-1.0.0/LICENSE` & `tenorgrabber-1.0.1/LICENSE`

 * *Files identical despite different names*

### Comparing `tenorgrabber-1.0.0/PKG-INFO` & `tenorgrabber-1.0.1/PKG-INFO`
...
### Comparing `tenorgrabber-1.0.0/README.md` & `tenorgrabber-1.0.1/README.md`

 * *Files identical despite different names*

### Comparing `tenorgrabber-1.0.0/TenorGrabber.egg-info/PKG-INFO` & `tenorgrabber-1.0.1/TenorGrabber.egg-info/PKG-INFO`
