# Comparing `tmp/python3_commons-0.5.0.tar.gz` & `tmp/python3_commons-0.5.1.tar.gz`
...
### Comparing `python3_commons-0.5.0/.coveragerc` & `python3_commons-0.5.1/.coveragerc`
