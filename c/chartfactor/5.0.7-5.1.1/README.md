# Comparing `tmp/chartfactor-5.0.7.tar.gz` & `tmp/chartfactor-5.1.1.tar.gz`
...
### Comparing `chartfactor-5.0.7/chartfactor.egg-info/SOURCES.txt` & `chartfactor-5.1.1/chartfactor.egg-info/SOURCES.txt`
