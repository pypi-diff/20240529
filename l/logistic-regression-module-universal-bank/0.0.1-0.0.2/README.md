# Comparing `tmp/logistic_regression_module_universal_bank-0.0.1.tar.gz` & `tmp/logistic_regression_module_universal_bank-0.0.2.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "logistic_regression_module_universal_bank-0.0.1.tar", last modified: Wed May 29 02:22:53 2024, max compression
...
## Comparing `logistic_regression_module_universal_bank-0.0.1.tar` & `logistic_regression_module_universal_bank-0.0.2.tar`

### file list

```diff
@@ -1,14 +1,15 @@
-drwxr-xr-x   0 taemin     (501) staff       (20)        0 2024-05-29 02:22:53.765003 logistic_regression_module_universal_bank-0.0.1/
--rw-r--r--   0 taemin     (501) staff       (20)      301 2024-05-29 02:22:53.764736 logistic_regression_module_universal_bank-0.0.1/PKG-INFO
--rw-r--r--   0 taemin     (501) staff       (20)        0 2024-05-29 01:57:52.000000 logistic_regression_module_universal_bank-0.0.1/README.md
-drwxr-xr-x   0 taemin     (501) staff       (20)        0 2024-05-29 02:22:53.762612 logistic_regression_module_universal_bank-0.0.1/lib/
--rw-r--r--   0 taemin     (501) staff       (20)       22 2024-05-29 02:06:19.000000 logistic_regression_module_universal_bank-0.0.1/lib/__init__.py
--rw-r--r--   0 taemin     (501) staff       (20)     3115 2024-05-29 02:09:28.000000 logistic_regression_module_universal_bank-0.0.1/lib/logistic_regression_module.py
-drwxr-xr-x   0 taemin     (501) staff       (20)        0 2024-05-29 02:22:53.764307 logistic_regression_module_universal_bank-0.0.1/logistic_regression_module_universal_bank.egg-info/
--rw-r--r--   0 taemin     (501) staff       (20)      301 2024-05-29 02:22:53.000000 logistic_regression_module_universal_bank-0.0.1/logistic_regression_module_universal_bank.egg-info/PKG-INFO
--rw-r--r--   0 taemin     (501) staff       (20)      392 2024-05-29 02:22:53.000000 logistic_regression_module_universal_bank-0.0.1/logistic_regression_module_universal_bank.egg-info/SOURCES.txt
--rw-r--r--   0 taemin     (501) staff       (20)        1 2024-05-29 02:22:53.000000 logistic_regression_module_universal_bank-0.0.1/logistic_regression_module_universal_bank.egg-info/dependency_links.txt
--rw-r--r--   0 taemin     (501) staff       (20)      124 2024-05-29 02:22:53.000000 logistic_regression_module_universal_bank-0.0.1/logistic_regression_module_universal_bank.egg-info/requires.txt
--rw-r--r--   0 taemin     (501) staff       (20)        4 2024-05-29 02:22:53.000000 logistic_regression_module_universal_bank-0.0.1/logistic_regression_module_universal_bank.egg-info/top_level.txt
--rw-r--r--   0 taemin     (501) staff       (20)       38 2024-05-29 02:22:53.765112 logistic_regression_module_universal_bank-0.0.1/setup.cfg
--rw-r--r--   0 taemin     (501) staff       (20)     1162 2024-05-29 02:21:03.000000 logistic_regression_module_universal_bank-0.0.1/setup.py
...
### Comparing `logistic_regression_module_universal_bank-0.0.1/lib/logistic_regression_module.py` & `logistic_regression_module_universal_bank-0.0.2/lib/logistic_regression_module.py`

 * *Files identical despite different names*

### Comparing `logistic_regression_module_universal_bank-0.0.1/setup.py` & `logistic_regression_module_universal_bank-0.0.2/setup.py`
